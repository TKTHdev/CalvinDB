...
class SequenceBatch;
class SequenceBatchDefaultTypeInternal;
extern SequenceBatchDefaultTypeInternal _SequenceBatch_default_instance_;
class UInt64Pair;
...
class Sequence : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Sequence) */ {
 public:
  Sequence();
  virtual ~Sequence();
  ...
  ::google::protobuf::uint64 batch_ids(int index) const;
  void set_batch_ids(int index, ::google::protobuf::uint64 value);
  void add_batch_ids(::google::protobuf::uint64 value);
 ...
 private:
  ...
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint64 > batch_ids_;
  friend struct  protobuf_scalar_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class SequenceBatch : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SequenceBatch) */ {
 public:
  SequenceBatch();
  virtual ~SequenceBatch();

  SequenceBatch(const SequenceBatch& from);

  inline SequenceBatch& operator=(const SequenceBatch& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const SequenceBatch& default_instance();

  static inline const SequenceBatch* internal_default_instance() {
    return reinterpret_cast<const SequenceBatch*>(
               &_SequenceBatch_default_instance_);
  }

  void Swap(SequenceBatch* other);

  // implements Message ----------------------------------------------

  inline SequenceBatch* New() const PROTOBUF_FINAL { return New(NULL); }

  SequenceBatch* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const SequenceBatch& from);
  void MergeFrom(const SequenceBatch& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(SequenceBatch* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  int sequence_batch_size() const;
  void clear_sequence_batch();
  static const int kSequenceBatchFieldNumber = 1;
  const ::Sequence& sequence_batch(int index) const;
  ::Sequence* mutable_sequence_batch(int index);
  ::Sequence* add_sequence_batch();
  ::google::protobuf::RepeatedPtrField< ::Sequence >*
      mutable_sequence_batch();
  const ::google::protobuf::RepeatedPtrField< ::Sequence >&
      sequence_batch() const;

  // @@protoc_insertion_point(class_scope:SequenceBatch)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::Sequence > sequence_batch_;
  friend struct  protobuf_scalar_2eproto::TableStruct;
};
// ===================================================================
...
// repeated uint64 batch_ids = 1;
inline int Sequence::batch_ids_size() const {
  return batch_ids_.size();
}
inline void Sequence::clear_batch_ids() {
  batch_ids_.Clear();
}
inline ::google::protobuf::uint64 Sequence::batch_ids(int index) const {
  // @@protoc_insertion_point(field_get:Sequence.batch_ids)
  return batch_ids_.Get(index);
}
inline void Sequence::set_batch_ids(int index, ::google::protobuf::uint64 value) {
  batch_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:Sequence.batch_ids)
}
inline void Sequence::add_batch_ids(::google::protobuf::uint64 value) {
...
inline const ::google::protobuf::RepeatedPtrField< ::Sequence >&
