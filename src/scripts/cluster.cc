...
DEFINE_string(ssh_key1, "~/.ssh/id_rsa", "ssh_key for the first data center(Virginia)");
DEFINE_string(ssh_key2, "~/.ssh/id_rsa", "ssh_key for the second data center(Oregon)");
DEFINE_string(ssh_key3, "~/.ssh/id_rsa", "ssh_key for the third data center(Ireland)");
DEFINE_string(ssh_key4, "~/.ssh/id_rsa", "ssh_key for the first data center(Virginia)");
DEFINE_string(ssh_key5, "~/.ssh/id_rsa", "ssh_key for the second data center(Oregon)");
DEFINE_string(ssh_key6, "~/.ssh/id_rsa", "ssh_key for the third data center(Ireland)");
