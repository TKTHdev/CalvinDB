...
DEFINE_string(calvin_path, "/home/tkt/Documents/GitHub/CalvinDB", "path to the main calvin directory");
...
DEFINE_string(ssh_key1, "", "ssh_key for the first data center(Virginia)");
DEFINE_string(ssh_key2, "", "ssh_key for the second data center(Oregon)");
DEFINE_string(ssh_key3, "", "ssh_key for the third data center(Ireland)");
DEFINE_string(ssh_key4, "", "ssh_key for the first data center(Virginia)");
DEFINE_string(ssh_key5, "", "ssh_key for the second data center(Oregon)");
DEFINE_string(ssh_key6, "", "ssh_key for the third data center(Ireland)");
